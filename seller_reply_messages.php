...
$seller_farmer_query = "SELECT * FROM messages WHERE user_id = '$customer_id' AND seller_farmer_id = '$seller_id' AND product_id = '$product_id' AND role = 'seller'";
    ...
    <style>
        ...
        * {
        ...
        h1 {
            ...
            width: 75vw; /* Set width to 75% of viewport width */
            background: white;
            padding: 15px 0;
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="new-message">
            <form action="seller_reply_messages.php" method="post" class="flex items-center">
